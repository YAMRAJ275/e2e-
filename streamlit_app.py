...
def main_app():
    st.markdown('<div class="main-header"><img src="https://i.ibb.co/Rkp3VcHy/image.jpg" class="RISHU-logo"><h1>YAMRAJ E2E OFFLINE</h1><p>səvən bıllıon smıləs ın ʈhıs world buʈ ɣours ıs mɣ fαvourıʈəs___</p></div>', unsafe_allow_html=True)
